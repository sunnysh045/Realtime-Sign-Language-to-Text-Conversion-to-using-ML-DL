  ...
  <body>
    ...
    <div class="container">
        <div class="sign-heading">
          <h3>Pretrained DL model to convert Sign language to Words</h3>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ol>
          <li>This is a pretrained sign gesture model, which is used to convert letters in complete sentence.</li>
          ...
          <li>After placing sign gesture in <strong>ROI</strong> Press <b>j</b> key from your keyboard to start
          appending letters.</li>
          <li>Suppose, if wrong letter gets appended to word, delete it by pressing <b>l</b> key from keyboard.</li>
          <li>To add space between each words, during the termination of word press <b>k</b> key from keyboard.</li>
      ...
      <div class="modal-footer">
        ...
        <!-- <button type="button" class="btn btn-primary">Save changes</button> -->
            ...
            <button class="btn btn-warning" onclick="textToAudio()" id="speak">Speak</button>
          </button>
        </div>
        <div id="pred-box">
            <h4 id="pred"></h4>
            <h5 id="letter">Predicted Letter</h5>
            <h5 id="conf"></h5>
        </div>
