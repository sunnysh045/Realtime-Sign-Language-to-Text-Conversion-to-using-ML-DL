  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="sign-heading">
          <h3>Pretrained DL model to recognize Numbers</h3>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ol>
          ...
          <li>Refer the below image for making sign gestures:
            <img src="images/signnumber.jpg" alt="sign gestures" width="300" height="250"></li>
        </ol>
      </div>
      <div class="modal-footer">
        ...
        <h4 id="letter">Predicted Number</h4>
    ...
    <script src="savedsketchknnnumber.js"></script>
    <!-- <script src="skerkchnumberknn.js"></script> -->
  </body>
</html>